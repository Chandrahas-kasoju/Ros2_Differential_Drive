...
package_name = "ros2_control_tests_nodes"
    ...
    entry_points={
        "console_scripts": [
            "publisher_forward_position_controller = \
                ros2_control_tests_nodes.publisher_forward_position_controller:main",
            "publisher_joint_trajectory_controller = \
                ros2_control_tests_nodes.publisher_joint_trajectory_controller:main",
            "vel_pub = \
                ros2_control_tests_nodes.vel_pub:main",
        ],
    },
)
